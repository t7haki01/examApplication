...
class examAppFixtures extends Fixture
{
    public function load(ObjectManager $manager){
        ...
        $dummyData1->setExamples(array('test1', 'test2', 'test3', 'test4'));
        $dummyData1->setAnswers(array('test1', 'test2'));
        ...
        $dummyData2->setExamples(array('test1', 'test2', 'test3', 'test4'));
        $dummyData2->setAnswers(array('test3', 'test4'));
